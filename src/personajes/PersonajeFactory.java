...
public class PersonajeFactory {
    ...
    public static Personaje crearMago() {
        ...
        switch (tipo) {
            case 0: return new Auror(nombre, 100, 100);
            case 1: return new Estudiante(nombre, 80, 80);
            case 2: return new Profesor(nombre, 120, 120);
    ...
    public static Personaje crearMortifago() {
        ...
        switch (tipo) {
            case 0: return new Comandante(nombre, 150, 150);
            case 1: return new Seguidor(nombre, 90, 90);
